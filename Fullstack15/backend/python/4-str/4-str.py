...
# print(string[2])      # l
# print('Hello'[:2])    # He
# print('Hello world'[:5:2])  # Hlo
# print('Hello world'[::2])  # ODD indexes
# print('Hello world'[1::2])  # EVEN indexes
# print('Hello'[::-1])  # olleH
# -----------------------------------
# INCLUDES
# len('Hello')  # 5
...
# REPLACE
# .replace('...', '...')  (==> .replaceAll())
# print("Hello wOrld  o".replace("o", '*'))

# ------------------------------------------------------------
# re.sub("WHAT", "TO WHAT", "WHERE", "HOW | FLAGS", "COUNT")
# ------------------------------------------------------------
...
# x = "Updated"
# x = f"This is {x} text"  # informal way of using format
# x = "This is {test} text".format(test=x)  # formal way of using format
# print(x)
# =================================================================
